...
import com.example.foodapp2.CartListAdapter;
import com.example.foodapp2.ManagementCart;
import com.example.foodapp2.ChangeNumberItemsListener;
...
public class CartList extends AppCompatActivity {
    ...
    private void bottomNavigation() {
        ...
        homeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(CartList.this, MainActivity.class));
            }
        });
    }
    ...
    private void calculateCard() {
        ...
        tax = Math.round((managementCart.getTotalFee() * percentTax) * 100) / 1000;
